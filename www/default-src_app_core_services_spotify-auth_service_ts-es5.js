(function () {
  ...
  (self["webpackChunkspotify_test"] = self["webpackChunkspotify_test"] || []).push([["default-src_app_core_services_spotify-auth_service_ts"], {
    /***/
    33804:
    /*!****************************************************************!*\
    ...
    55818:
    /*!*******************************************************!*\
      !*** ./src/app/core/services/spotify-auth.service.ts ***!
      \*******************************************************/
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, {
        /* harmony export */
        "SpotifyAuthService": function SpotifyAuthService() {
          return (
            /* binding */
            _SpotifyAuthService
          );
      ...
      var _SpotifyAuthService = /*#__PURE__*/function () {
        function SpotifyAuthService(commonService, navCtrl) {
        ...
        _createClass(SpotifyAuthService, [{
          ...
          value: function auth() {
            ...
            cordova.plugins.spotifyAuth.authorize(config).then(function (auth) {
              ...
              if (auth.accessToken) {
                ...
                _this.commonService.setAuth(auth);

                _this.spotifyApi.setAccessToken(auth.accessToken);
            ...
            })["catch"](function (err) {//cordova.plugins.spotifyAuth.forget();
              // this.auth();
            });
          }
        }, {
          ...
          value: function getUser() {
            var data = this.spotifyApi.getUser().then(function (data) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return this.spotifyApi.getFeaturedPlaylists().then(function (data) {
                        return data.playlists;
                      }, function (err) {
                        console.error(err);
                      });
          ...
          value: function follow(id) {
            this.spotifyApi.followPlaylist(id).then(function (data) {
              console.log(data); //this.list = data.items;
            }, function (err) {
              console.error(err);
            });
          }
          ...
          value: function unfollow(id) {
            this.spotifyApi.unfollowPlaylist(id).then(function (data) {
              console.log(data); //this.list = data.items;
            }, function (err) {
              console.error(err);
            });
      ...
      _SpotifyAuthService.ctorParameters = function () {
        return [{
      ...
      _SpotifyAuthService = (0, tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0, _angular_core__WEBPACK_IMPORTED_MODULE_6__.Injectable)({
        providedIn: 'root'
      })], _SpotifyAuthService);
      /***/
    }
...
//# sourceMappingURL=default-src_app_core_services_spotify-auth_service_ts-es5.js.map