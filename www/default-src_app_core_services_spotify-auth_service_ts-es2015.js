...
/* harmony export */   "SpotifyAuthService": function() { return /* binding */ SpotifyAuthService; }
/* harmony export */ });
...
let SpotifyAuthService = class SpotifyAuthService {
    constructor(commonService, navCtrl) {
        var _a;
    ...
    getUser() {
        let data = this.spotifyApi.getUser().then((data) => {
    ...
    getPlayList() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            let data = yield this.spotifyApi.getFeaturedPlaylists()
                .then((data) => {
                return data.playlists;
            }, err => {
                console.error(err);
...
SpotifyAuthService.ctorParameters = () => [
    { type: src_app_core_services_common_service__WEBPACK_IMPORTED_MODULE_0__.CommonService },
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_5__.NavController }
];
SpotifyAuthService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
//# sourceMappingURL=default-src_app_core_services_spotify-auth_service_ts-es2015.js.map